        ...
        (video || detail) && <div className="bg-black text-white">
            ...
            {detail && <div>
                <div className=" px-4 md:px:6 xl:px-8 text-white h-fit bg-black">
                    <div className="flex gap-2 text-white/90 px-2 pt-2">
                        {detail.genres.map((genre, index) => {
                            return (
                                <div key={genre.id || index} className="flex font-extralight flex-wrap items-center gap-1">
                                <p className="border-1 border-white/70 rounded-4xl px-2 md:px-4">{genre.name}</p>
