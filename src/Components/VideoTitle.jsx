    ...
    return (
        <div className="absolute w-fit  top-40 left-4 sm:md:top-50 sm:md:left-11  text-white/80   ">
                ...
                <div className="w-fit  flex gap-3 mt-4 md:mt-4 xl:mt-0 ">
                    ...
                    <button className=" outline-0 hover:bg-gray-500 cursor-pointer px-2 py-1 md:px-8 md:py-2 bg-gray-600 text-white  flex gap-2 items-center font-medium rounded-sm">
