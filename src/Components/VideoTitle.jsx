...
const VideoTitle = ({ title, overview }) => {
    return (
        <div className=" absolute top-0 w-screen aspect-video  pt-54 text-white/80 px-18 bg-gradient-to-r from-black/70 ">
            <h1 className="text-5xl font-bold" >{title}</h1>
            <p className="py-6 text-lg pr-6 w-[30%]">{overview}</p>

            <div className="flex gap-3 ">
                <button className=" text-black cursor-pointer px-8 bg-white hover:bg-white/80 flex items-center  py-2  font-medium rounded-sm">
                ...
                <button className="hover:bg-gray-500 cursor-pointer px-8 bg-gray-600 text-white  flex gap-2 items-center  py-2 font-medium rounded-sm">
